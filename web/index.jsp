...
<html lang="en" >
    ...
    <body>
                        ...
                        <div class="timeline">
                            <div class="timeline-wrapper">
                                ...
                                <div class="timeline-info">
                                    ...
                                    <p>Agrega todas las clases que ofrece tu negocio.</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-wrapper">
                                ...
                                <div class="timeline-info">
                                    ...
                                    <p>Podrás añadir las aulas o espacios donde desarrollaran las actividades.</p>
                                </div>
                            </div>
                        ...
                        <div class="timeline">
                            <div class="timeline-wrapper">
                                ...
                                <div class="timeline-info">
                                    ...
                                    <p>Crea, Organiza y gestiona los horarios que necesite tu negocio</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-wrapper">
                                ...
                                <div class="timeline-info">
                                    <h3><span>Usuario</h3>
                                    <p>Controla los privilegios de cada usuario con un simple rol.</p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="about full-screen d-lg-flex justify-content-center align-items-center" id="Funcionalidades">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 col-12" id="ventajas">
                        <div class="about-text">
                            ...
                            <p>Reducción del tiempo de administración.</p>

                            <p>Toda la información se guardará en un sitio seguro sin posibilidad de que se pierda. </p>
