...
public class RolDAO extends Conexion{
    ...
    public ArrayList<UsuarioVO> roles (String idTipoUsuario) {
        ...
        try {
            ...
            sql = "SELECT usuario.idUsuario, tipousuario.tipoUsuario,usuario.idGrupo,grupo.nombre,usuario.nombre,usuario.apellido from usuario INNER JOIN tipousuario on usuario.idTipoUsuario= tipousuario.idTipoUsuario INNER JOIN grupo ON grupo.idGrupo=usuario.idGrupo where correo = ?";
